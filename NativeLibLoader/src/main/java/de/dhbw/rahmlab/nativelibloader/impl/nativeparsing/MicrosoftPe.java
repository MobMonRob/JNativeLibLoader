...
public class MicrosoftPe extends KaitaiStruct {
	...
	public enum PeFormat {
		...
		public static PeFormat byId(long id) {
			return byId.get(id);
		}
	}
	...
	/**
	 * @see
	 * <a href="https://docs.microsoft.com/en-us/windows/desktop/debug/pe-format#the-attribute-certificate-table-image-only">Source</a>
	 */
	public static class CertificateEntry extends KaitaiStruct {
		...
		public enum CertificateRevision {
			...
			public static CertificateRevision byId(long id) {
				return byId.get(id);
			}
		}
		...
		public enum CertificateType {
			...
			public static CertificateType byId(long id) {
				return byId.get(id);
			}
		}
		...
		public MicrosoftPe _root() {
			return _root;
		}

		public MicrosoftPe.CertificateTable _parent() {
			return _parent;
		}
	}
	...
	public static class OptionalHeaderWindows extends KaitaiStruct {
		...
		public enum SubsystemEnum {
			...
			public static SubsystemEnum byId(long id) {
				return byId.get(id);
			}
		}
		...
		public Long sizeOfStackReserve32() {
			return sizeOfStackReserve32;
		}

		public Long sizeOfStackReserve64() {
			return sizeOfStackReserve64;
		}

		public Long sizeOfStackCommit32() {
			return sizeOfStackCommit32;
		}

		public Long sizeOfStackCommit64() {
			return sizeOfStackCommit64;
		}

		public Long sizeOfHeapReserve32() {
			return sizeOfHeapReserve32;
		}

		public Long sizeOfHeapReserve64() {
			return sizeOfHeapReserve64;
		}

		public Long sizeOfHeapCommit32() {
			return sizeOfHeapCommit32;
		}

		public Long sizeOfHeapCommit64() {
			return sizeOfHeapCommit64;
		}
		...
		public MicrosoftPe.OptionalHeader _parent() {
			return _parent;
		}
	}
	...
	public static class OptionalHeaderDataDirs extends KaitaiStruct {
		...
		public DataDir exportTable() {
			return exportTable;
		}

		public DataDir importTable() {
			return importTable;
		}

		public DataDir resourceTable() {
			return resourceTable;
		}

		public DataDir exceptionTable() {
			return exceptionTable;
		}

		public DataDir certificateTable() {
			return certificateTable;
		}

		public DataDir baseRelocationTable() {
			return baseRelocationTable;
		}

		public DataDir debug() {
			return debug;
		}

		public DataDir architecture() {
			return architecture;
		}

		public DataDir globalPtr() {
			return globalPtr;
		}

		public DataDir tlsTable() {
			return tlsTable;
		}

		public DataDir loadConfigTable() {
			return loadConfigTable;
		}

		public DataDir boundImport() {
			return boundImport;
		}
		...
		public DataDir delayImportDescriptor() {
			return delayImportDescriptor;
		}

		public DataDir clrRuntimeHeader() {
	...
	public static class DataDir extends KaitaiStruct {
		...
		public MicrosoftPe.OptionalHeaderDataDirs _parent() {
			return _parent;
		}
	}
	...
	public static class CoffSymbol extends KaitaiStruct {
		...
		public SectionHeader section() {
			...
			this.section = _root.pe().sectionHeaderTable().get((int) (sectionNumber() - 1));
			return this.section;
		}
		private byte[] data;
		...
		public Annoyingstring nameAnnoying() {
			return nameAnnoying;
		}
		...
		public MicrosoftPe.CoffHeader _parent() {
			return _parent;
		}

		public byte[] _raw_nameAnnoying() {
			return _raw_nameAnnoying;
		}
	}
	...
	public static class PeHeader extends KaitaiStruct {
		...
		private void _read() {
			...
			sectionHeaderTable = new ArrayList<SectionHeader>(((Number) (coffHdr().numberOfSections())).intValue());
			for (int i = 0; i < coffHdr().numberOfSections(); i++) {
				this.sectionHeaderTable.add(new SectionHeader(this._io, this, _root));
			}
		}
		...
		private ArrayList<SectionHeader> sectionHeaderTable;
		private MicrosoftPe _root;
		...
		public CoffHeader coffHdr() {
			return coffHdr;
		}

		public OptionalHeader optionalHdr() {
			return optionalHdr;
		}

		public ArrayList<SectionHeader> sectionHeaderTable() {
		...
		public MicrosoftPe _parent() {
			return _parent;
		}

		public byte[] _raw_optionalHdr() {
			return _raw_optionalHdr;
		}

		public byte[] _raw_certificateTable() {
			return _raw_certificateTable;
		}
	}
	...
	public static class SectionHeader extends KaitaiStruct {
		...
		public SectionHeader(KaitaiStream _io, MicrosoftPe.PeHeader _parent) {
			this(_io, _parent, null);
		}

		public SectionHeader(KaitaiStream _io, MicrosoftPe.PeHeader _parent, MicrosoftPe _root) {
			super(_io);
			this._parent = _parent;
			this._root = _root;
			_read();
		...
		public Integer offset() {
			...
			int _tmp = (int) ((pointerToRawData() - virtualAddress()));
			this.offset = _tmp;
			return this.offset;
		}
		...
		public ImportSection importSection() {
			...
			if (((virtualAddress() <= _root.pe().optionalHdr().dataDirs().importTable().virtualAddress()) && ((virtualAddress() + virtualSize()) > _root.pe().optionalHdr().dataDirs().importTable().virtualAddress()))) {
				long _pos = this._io.pos();
				this._io.seek(pointerToRawData());
				this._raw_importSection = this._io.readBytes(sizeOfRawData());
				KaitaiStream _io__raw_importSection = new ByteBufferKaitaiStream(_raw_importSection);
				this.importSection = new ImportSection(_io__raw_importSection, this, _root);
				this._io.seek(_pos);
			}
			return this.importSection;
		}
		...
		private byte[] _raw_importSection;
		...
		public MicrosoftPe.PeHeader _parent() {
			return _parent;
		}

		public byte[] _raw_importSection() {
			return _raw_importSection;
		}
	}
	...
	public static class OptionalHeader extends KaitaiStruct {
		...
		public OptionalHeaderStd std() {
			return std;
		}

		public OptionalHeaderWindows windows() {
			return windows;
		}

		public OptionalHeaderDataDirs dataDirs() {
			return dataDirs;
		}
	...
	public static class ImageImportDescriptor extends KaitaiStruct {

		public static ImageImportDescriptor fromFile(String fileName) throws IOException {
			return new ImageImportDescriptor(new ByteBufferKaitaiStream(fileName));
		}

		public ImageImportDescriptor(KaitaiStream _io) {
			this(_io, null, null);
		}

		public ImageImportDescriptor(KaitaiStream _io, MicrosoftPe.ImportSection _parent) {
			this(_io, _parent, null);
		}

		public ImageImportDescriptor(KaitaiStream _io, MicrosoftPe.ImportSection _parent, MicrosoftPe _root) {
			super(_io);
			this._parent = _parent;
			this._root = _root;
			_read();
		...
		private void _read() {
			...
			this.forwarderChain = this._io.readU4le();
			this.nameRva = this._io.readU4le();
			this.firstThunk = this._io.readU4le();
		}
		private Integer nameOffset;

		public Integer nameOffset() {
			if (this.nameOffset != null) {
				return this.nameOffset;
			}
			int _tmp = (int) ((_parent()._parent().offset() + nameRva()));
			this.nameOffset = _tmp;
			return this.nameOffset;
		}
		private String name;
		...
		private long firstThunk;
		private MicrosoftPe _root;
		private MicrosoftPe.ImportSection _parent;
		...
		public MicrosoftPe.ImportSection _parent() {
			return _parent;
		}
	}
	...
	public static class CertificateTable extends KaitaiStruct {
		...
		public ArrayList<CertificateEntry> items() {
			return items;
		}
	...
	public static class ImportSection extends KaitaiStruct {
		...
		public ImportSection(KaitaiStream _io, MicrosoftPe.SectionHeader _parent) {
			this(_io, _parent, null);
		}

		public ImportSection(KaitaiStream _io, MicrosoftPe.SectionHeader _parent, MicrosoftPe _root) {
			super(_io);
			this._parent = _parent;
			this._root = _root;
			_read();
		...
		private void _read() {
			this.importTable = new ArrayList<ImageImportDescriptor>();
			{
				ImageImportDescriptor _it;
				int i = 0;
				do {
					_it = new ImageImportDescriptor(this._io, this, _root);
					this.importTable.add(_it);
					i++;
				} while (!(_it.characteristics() == 0));
			}
		}
		private Integer importTableInstanceOffset;

		public Integer importTableInstanceOffset() {
			if (this.importTableInstanceOffset != null) {
				return this.importTableInstanceOffset;
			}
			int _tmp = (int) ((_parent().offset() + _root.pe().optionalHdr().dataDirs().importTable().virtualAddress()));
			this.importTableInstanceOffset = _tmp;
			return this.importTableInstanceOffset;
		}
		private ArrayList<ImageImportDescriptor> importTable;
		private MicrosoftPe _root;
		private MicrosoftPe.SectionHeader _parent;

		public ArrayList<ImageImportDescriptor> importTable() {
			return importTable;
		}
		...
		public MicrosoftPe.SectionHeader _parent() {
			return _parent;
		}
	}
	...
	public static class CoffHeader extends KaitaiStruct {
		...
		public enum MachineType {
			...
			public static MachineType byId(long id) {
				return byId.get(id);
			}
		}
	...
	public static class Annoyingstring extends KaitaiStruct {
		...
		public MicrosoftPe.CoffSymbol _parent() {
			return _parent;
		}
	}
	private PeHeader pe;
