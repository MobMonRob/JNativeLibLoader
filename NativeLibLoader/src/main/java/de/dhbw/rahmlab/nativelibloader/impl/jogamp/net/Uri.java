 ...
 * the License.
 */
package de.dhbw.rahmlab.nativelibloader.impl.jogamp.net;
...
import de.dhbw.rahmlab.nativelibloader.impl.jogamp.util.PropertyAccess;

/**
 * This class implements an immutable Uri as defined by
 * <a href="https://tools.ietf.org/html/rfc2396">RFC 2396</a>.
 * <p>
 * Character encoding is employed as defined by
 * <a href="https://tools.ietf.org/html/rfc3986">RFC 3986</a>, see
 * <a href="https://tools.ietf.org/html/rfc3986#section-2.1">RFC 3986 section
 * 2.1</a>, while multibyte unicode characters are preserved in encoded parts.
 * </p>
 *
 * <pre>
 ...
 * </pre>
 * <p>
 * <a href="https://tools.ietf.org/html/rfc3986#section-2.2">RFC 3986 section
 * 2.2</a> <i>Reserved Characters</i> (January 2005)
 * <table border="1">
 * <tr>
 * <td><code>!</code></td>
 * <td><code>*</code></td>
 ...
 * </p>
 * <p>
 * <a href="https://tools.ietf.org/html/rfc3986#section-2.3">RFC 3986 section
 * 2.3</a> <i>Unreserved Characters</i> (January 2005)
 * <table border="1">
 * <tr>
 * <td><code>A</code></td>
 * <td><code>B</code></td>
...
public class Uri {
     ...
     * {@link #valueOf(URI)} and {@link #valueOf(URL)} where the given URL or
     * URI was opaque!
     * </p>
     * <p>
     * This remedies issues when dealing w/ java URI/URL opaque sources, which
     * do not comply to the spec, i.e. containe un-encoded chars, e.g. ':', '$',
     * ..
     * </p>
     */
    ...
    /**
     * Valid charset for RFC 2396 {@code authority}, additional to legal
     * {@code alphanum} characters.
     * <p>
     * {@value} + {@code alphanum}
     * </p>
     */
    ...
    /**
     * Valid charset for RFC 2396 {@code path}, additional to legal
     * {@code alphanum} characters.
     * <p>
     * {@value} + {@code alphanum}
     * </p>
    ...
    /**
     * Valid charset for RFC 2396 {@code query}, additional to legal
     * {@code alphanum} characters.
     * <p>
     * {@value} + {@code alphanum}
     * </p>
    ...
    /**
     * Valid charset for RFC 2396 {@code scheme-specific-part}, additional to
     * legal {@code alphanum} characters.
     * <p>
     * {@value} + {@code alphanum}
     * </p>
     */
    ...
    /**
     * Valid charset for RFC 2396 {@code fragment}, additional to legal
     * {@code alphanum} characters.
     * <p>
     * {@value} + {@code alphanum}
     * </p>
    ...
    /**
     * A JAR sub-protocol is separated from the JAR entry w/ this separator
     * {@value}. Even if no class is specified '!/' must follow!.
     */
    ...
    public static class Encoded implements Comparable<Encoded>, CharSequence {
        ...
        /**
         * Encodes all characters into their hexadecimal value prepended by '%',
         * except:
         * <ol>
         * <li>letters ('a'..'z', 'A'..'Z')</li>
         * <li>numbers ('0'..'9')</li>
         * <li>characters in the legal-set parameter</li>
         * <li> others (unicode characters that are not in US-ASCII set, and are
         * not ISO Control or are not ISO Space characters)</li>
         * </ol>
         * <p>
         ...
         * @param legal extended character set, allowed to be preserved in the
         * vanilla string
         */
         ...
         * x-www-form-urlencoded} MIME content type using the UTF-8 encoding
         * scheme.
         * <p>
         ...
         * {@inheritDoc}
         *
         * @param o The comparison argument, either a {@link Encoded} or a
         * {@link String}
         *
         * @return {@code true} if the given object is equivalent to this
        ...
        @Override
        public final int compareTo(final Encoded o) {
        ...
        public Encoded concat(final Encoded encoded) {
            return new Encoded(s.concat(encoded.s));
        }

        /**
         * See {@link String#substring(int)}.
         */
        public final Encoded substring(final int start) {
            return new Encoded(s.substring(start));
        }

        /**
         * See {@link String#substring(int, int)}.
         */
        public final Encoded substring(final int start, final int end) {
            return new Encoded(s.substring(start, end));
        }
         ...
         */
        public final int indexOf(final int ch, final int fromIndex) {
         ...
         */
        public final boolean equalsIgnoreCase(final Encoded anotherEncoded) {
            return s.equalsIgnoreCase(anotherEncoded.s);
        }
    }
    ...
    public static class ASCIIEncoded extends Encoded {
        ...
        /**
         * Casts the given encoded String by creating a new ASCIIEncoded
         * instance.
         * <p>
         * No encoding will be performed, use with care.
         * </p>
        ...
        /**
         * Other characters, which are Unicode chars that are not US-ASCII, and
         * are not ISO Control or are not ISO Space chars are not preserved and
         * encoded into their hexidecimal value prepended by '%'.
         * <p>
    ...
    /**
     * All characters are encoded into their hexadecimal value prepended by '%',
     * except:
     * <ol>
     * <li>letters ('a'..'z', 'A'..'Z')</li>
     * <li>numbers ('0'..'9')</li>
     * <li>characters in the legal-set parameter</li>
     * <li> others (unicode characters that are not in US-ASCII set, and are not
     * ISO Control or are not ISO Space characters)</li>
     * </ol>
     * <p>
     * Use {@link #encodeToASCIIString(String)} for US-ASCII encoding.
     * </p>
     * <p>
     * Consider using {@link Encoded#Encoded(String, String)} in APIs to
     * distinguish encoded from unencoded data by type.
     * </p>
     *
     * @param vanilla the string to be encoded
     * @param legal extended character set, allowed to be preserved in the
     ...
     * not ISO Control or are not ISO Space chars are not preserved and encoded
     * into their hexidecimal value prepended by '%'.
     * <p>
     * For example: Euro currency symbol -> "%E2%82%AC".
     * </p>
     * <p>
     * Consider using {@link ASCIIEncoded#ASCIIEncoded(String)} in APIs to
     * distinguish encoded from unencoded data by type.
     * </p>
     *
     ...
     *
     * @param encoded {@link Encoded} instance to be decoded, may be
     * {@code null}.
     * @return the {@link Encoded#decode() decoded} String or {@code null} if
     * {@code encoded} was {@code null}.
     */
     ...
     * <p>
     * This constructor first creates a temporary Uri string from the given
     * unencoded components. This string will be parsed later on to create the
     * Uri instance.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * {@code host} and {@code port} <i>may</i> be undefined or invalid within
     * {@code scheme-specific-part}.
     * </p>
     *
     ...
     * @throws URISyntaxException if the temporary created string doesn't fit to
     * the specification RFC2396 or could not be parsed correctly.
     */
     ...
     * <p>
     * This constructor first creates a temporary Uri string from the given
     * encoded components. This string will be parsed later on to create the Uri
     * instance.
     * </p>
     * <p>
     * The given encoded components are taken as-is, i.e. no re-encoding will be
     * performed! However, Uri parsing will re-evaluate encoding of the
     ...
     * </p>
     * <p>
     * {@code host} and {@code port} <i>must</i> be defined and valid, if any
     * {@code authority} components are defined, i.e. {@code user-info},
     * {@code host} or {@code port}.
     * </p>
     *
     * @param scheme the unencoded scheme part of the Uri.
     * @param userinfo the unencoded user information of the Uri for
     * authentication and authorization, {@code null} for undefined.
     * @param host the unencoded host name of the Uri, {@code null} for
     * undefined.
     * @param port the port number of the Uri, -1 for undefined.
     * @param path the unencoded path to the resource on the host.
     * @param query the unencoded query part of the Uri to specify parameters
     * for the resource.
     * @param fragment the unencoded fragment part of the Uri.
     * @throws URISyntaxException if the temporary created string doesn't fit to
     * the specification RFC2396 or could not be parsed correctly.
     ...
     *
     * @param scheme the encoded scheme part of the Uri.
     * @param userinfo the encoded user information of the Uri for
     * authentication and authorization, {@code null} for undefined.
     ...
     * @param query the encoded query part of the Uri to specify parameters for
     * the resource.
     * @param fragment the encoded fragment part of the Uri.
     * @throws URISyntaxException if the temporary created string doesn't fit to
     * the specification RFC2396 or could not be parsed correctly.
     ...
     * </p>
     * <p>
     * {@code host} and {@code port} <i>may</i> be undefined or invalid, in the
     * optional {@code authority}.
     * </p>
     *
     * @param scheme the unencoded scheme part of the Uri.
     ...
     * <p>
     * This constructor first creates a temporary Uri string from the given
     * encoded encoded components. This string will be parsed later on to create
     * the Uri instance.
     * </p>
     * <p>
     * The given encoded components are taken as-is, i.e. no re-encoding will be
    ...
    /**
     * Casts the given encoded String to a
     * {@link Encoded#cast(String) new Encoded instance} used to create the
     * resulting Uri instance via {@link #Uri(Encoded)}.
     * <p>
     * No encoding will be performed on the given {@code encodedUri}, use with
     * care.
     * </p>
     *
     ...
     * <p>
     * This constructor first creates a temporary Uri string from the given
     * components. This string will be parsed later on to create the Uri
     * instance.
     * </p>
     * <p>
     * {@code file:path}
     ...
     *
     * @param file using
     * {@link IOUtil#slashify(String, boolean, boolean) slashified} {@link File#getAbsolutePath() absolute-path}
     * for the path of the {@code file} {@code schema}, utilizing
     * {@link #valueOfFilepath(String)}.
     * @throws URISyntaxException if the temporary created string doesn't fit to
     * the specification RFC2396 or could not be parsed correctly.
     */
     ...
     * <p>
     * Re-encoding will be performed if the given URI is
     * {@link URI#isOpaque() not opaque}.
     * </p>
     * <p>
    ...
    /**
     * Creates a new Uri instance using the given URL instance, convenient
     * wrapper for {@link #valueOf(URI)} and {@link URL#toURI()}.
     * <p>
     * Re-encoding will be performed if the given URL is
     * {@link URI#isOpaque() not opaque}, see {@link #valueOf(URI)}.
     * </p>
     * <p>
     * See {@link #PARSE_HINT_FIX_PATH} for issues of injecting opaque URLs.
     * </p>
    ...
    /**
     * Encoded {@code path} part of {@code scheme-specific-part}, never
     * {@code null}.
     */
    ...
    /**
     * Encoded {@code authority} part of {@code scheme-specific-part},
     * {@code null} if undefined.
     */
    public final Encoded authority;
    /**
     * Encoded {@code userinfo} part of {@code authority} and
     * {@code scheme-specific-part}, {@code null} if undefined.
     */
    public final Encoded userInfo; // part of authority
    /**
     * Encoded {@code host} part of {@code authority} and
     * {@code scheme-specific-part}, {@code null} if undefined.
     */
    public final Encoded host;     // part of authority
    /**
     * Encoded {@code port} part of {@code authority} and
     * {@code scheme-specific-part}, {@code -1} if undefined.
     */
    public final int port;        // part of authority

    /**
     * Encoded {@code query} part of {@code scheme-specific-part}, {@code null}
     * if undefined.
     */
    ...
    /**
     * Indicating whether this Uri is absolute, i.e. has a {@code scheme} and
     * hence an absolute {@code scheme-specific-part}.
     */
    public final boolean absolute;

    /**
     * Indicating whether this Uri is opaque, i.e. non-hierarchical
     * {@code scheme-specific-part}.
     * <p>
     * An opaque Uri has no {@code scheme-specific-part} being parsed, i.e.
     * {@code path}, {@code query} and {@code authority} are {@code null}.
     * </p>
     */
    public final boolean opaque;

    /**
     * Creates a new Uri instance according to the given encoded string
     * {@code uri}.
     *
     * @param uri the RFC3986 encoded RFC2396 Uri representation to be parsed
     * into a Uri object
     * @throws URISyntaxException if the given string {@code uri} doesn't fit to
     * the specification RFC2396 and RFC3986 or could not be parsed correctly.
     */
    ...
    /**
     * Returns true, if this instance is a {@code file} {@code scheme},
     * otherwise false.
     */
    ...
    /**
     * Returns true, if this instance is a {@code jar} {@code scheme}, otherwise
     * false.
     *
     * @since 2.3.2
     */
    ...
    /**
     * Returns the encoded {@link #input} as String, never {@code null}, same as
     * {@link #getEncoded()}.
     */
    @Override
    public final String toString() {
    ...
    /**
     * Returns a new {@link URI} instance using the encoded {@link #input}
     * string, {@code new URI(uri.input)}, i.e. no re-encoding will be
     * performed.
     *
     ...
     * <p>
     * All Uri parts of this instance will be decoded and encoded by the URI
     * constructor, i.e. re-encoding will be performed.
     * </p>
     *
     * @throws URISyntaxException if the given string {@code uri} doesn't fit to
     * the specification RFC2396 or could not be parsed correctly.
    ...
    /**
     * Returns a new {@link URL} instance using the encoded {@link #input}
     * string, {@code new URL(uri.input)}, i.e. no re-encoding will be
     * performed.
     *
     * @throws MalformedURLException if an error occurs while creating the URL
     * or no protocol handler could be found.
     */
    ...
    /**
     * If this instance {@link #isFileScheme() is a file scheme}, implementation
     * decodes <i>[ "//"+{@link #authority} ] + {@link #path}</i>,<br>
    ...
    /**
     * If this instance's {@link #schemeSpecificPart} contains a Uri itself, a
     * sub-Uri, return {@link #schemeSpecificPart} + {@code #} {@link #fragment}
     ...
     * </pre>
     *
     * @throws URISyntaxException if this Uri is a container Uri and does not
     * comply with the container spec, i.e. a JAR Uri
     */
    ...
    /**
     * {@link IOUtil#cleanPathString(String) Normalizes} this Uri's path and
     * return the {@link IOUtil#cleanPathString(String) normalized} form if it
     * differs, otherwise {@code this} instance.
     * <p>
     * <
     * pre>
     * Example-1: This instance :
     * <code>jar:http://some/path/../gluegen-rt.jar!/com/Test.class?arg=1#frag</code>
     * Normalized :
     * <code>jar:http://some/gluegen-rt.jar!/com/Test.class?arg=1#frag</code>
     *
     * Example-2: This instance :
     * <code>http://some/path/../gluegen-rt.jar?arg=1#frag</code> Normalized :
     * <code>http://some/gluegen-rt.jar?arg=1#frag</code>
     * </pre>
     * </p>
     */
     ...
     * <p>
     * This Uri path will be {@link IOUtil#cleanPathString(String) normalized}
     * before returning the directory.
     * </p>
     * <p>
     * If this Uri's directory cannot be found, or already denotes a directory,
     * method returns {@code this} instance.
     * </p>
     * <p>
     * <
     * pre>
     * Example-1: this-uri: http:/some/path/gluegen-rt.jar?arg=1#frag result:
     * http:/some/path/?arg=1#frag
     *
     * Example-2: this-uri: file:/some/path/ result: file:/some/path/
     *
     * Example-3: this-uri: file:/some/path/lala/lili/../../hello.txt result:
     * file:/some/path/
     * </pre>
     * </p>
     *
     * @throws URISyntaxException if the new string {@code uri} doesn't fit to
     * the specification RFC2396 and RFC3986 or could not be parsed correctly.
     */
     ...
     * <p>
     * This Uri path will be {@link IOUtil#cleanPathString(String) normalized}
     * before traversing up one directory.
     * </p>
     * <p>
     ...
     * <code>jar:http://some/path/gluegen-rt.jar!/com/Test.class?arg=1#frag</code>
     * Returned Uri #1:
     * <code>jar:http://some/path/gluegen-rt.jar!/com/?arg=1#frag</code>
     * Returned Uri #2:
     * <code>jar:http://some/path/gluegen-rt.jar!/?arg=1#frag</code> Returned
     * Uri #3: <code>null</code>
     *
     * Example-2: This instance :
     * <code>http://some/path/gluegen-rt.jar?arg=1#frag</code> Returned Uri #1:
     * <code>http://some/path/?arg=1#frag</code> Returned Uri #2:
     * <code>http://some/?arg=1#frag</code> Returned Uri #2: <code>null</code>
     *
     * Example-3: This instance :
     * <code>http://some/path/../gluegen-rt.jar?arg=1#frag</code> Returned Uri
     * #1: <code>http://some/?arg=1#frag</code> Returned Uri #2:
     * <code>null</code>
     * </pre>
     * </p>
     */
    ...
    /**
     * Returns a new Uri appending the given {@code appendPath} to this
     * instance's {@link #getDirectory() directory}.
     * <p>
     * If {@code appendPath} is empty, method behaves like
     * {@link #getNormalized()}.
     * </p>
     * <p>
     * This resulting path will be
     * {@link IOUtil#cleanPathString(String) normalized}.
     * </p>
     * <p>
     * <
     * pre>
     * Example-1: append: null this-uri: http:/some/path/gluegen-rt.jar result:
     * http:/some/path/gluegen-rt.jar
     *
     * Example-2: append: test.txt this-uri: file:/some/path/gluegen-rt.jar
     * result: file:/some/path/test.txt
     *
     * Example-3: append: test.txt this-uri:
     * file:/some/path/lala/lili/../../hello.txt result:
     * file:/some/path/test.txt
     * </pre>
     * </p>
     *
     * @param appendPath denotes a relative path to be appended to this Uri's
     * directory
     * @throws URISyntaxException if the resulting {@code uri} doesn't fit to
     * the specification RFC2396 and RFC3986 or could not be parsed correctly.
     */
    ...
    /**
     * Concatenates the given encoded string to the
     * {@link #getEncoded() encoded uri} of this instance and returns
     * {@link #Uri(Encoded) a new Uri instance} with the result.
     *
     * @throws URISyntaxException if the concatenated string {@code uri} doesn't
     * fit to the specification RFC2396 and RFC3986 or could not be parsed
     * correctly.
     */
     ...
     *
     * @throws URISyntaxException if this Uri is {@link #opaque} or if the new
     * string {@code uri} doesn't fit to the specification RFC2396 and RFC3986
     ...
     * </p>
     *
     * @param o the Uri this instance has to be compared with.
    ...
    /**
     * distinguish between IPv4, IPv6, domain name and validate it based on its
     * type
     */
     ...
     * </ol>
     *
     * @param encoded {@code java.lang.String} the string to be validated
     * @param legal {@code java.lang.String} the characters allowed in the
     * String s
     */
