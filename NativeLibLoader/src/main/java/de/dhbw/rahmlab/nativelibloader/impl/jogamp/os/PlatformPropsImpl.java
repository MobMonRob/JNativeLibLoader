...
import de.dhbw.rahmlab.nativelibloader.impl.jogamp.os.Platform.ABIType;
import de.dhbw.rahmlab.nativelibloader.impl.jogamp.os.Platform.CPUFamily;
import de.dhbw.rahmlab.nativelibloader.impl.jogamp.os.Platform.CPUType;
import de.dhbw.rahmlab.nativelibloader.impl.jogamp.os.Platform.OSType;
import de.dhbw.rahmlab.nativelibloader.impl.jogamp.util.VersionNumber;

/**
 * Abstract parent class of {@link Platform} initializing and holding platform
 * information, which are initialized independent of other classes.
 * <p>
 * This class is not intended to be exposed in the public namespace and solely
 * exist to solve initialization interdependencies.<br>
...
public abstract class PlatformPropsImpl {
    ...
    /**
     * Selected {@link Platform.OSType#MACOS} or
     * {@link Platform.OSType#IOS} {@link VersionNumber}s.
     */
    ...
    /**
     * Returns {@code true} if the given {@link CPUType}s and {@link ABIType}s
     * are compatible.
     */
    ...
    /**
     * Version 1.9. As a JVM version, it enables certain JVM 1.9 features. Note
     * the skipped first version number due to JEP 223.
     */
    ...
    /**
     * True if having {@link java.nio.LongBuffer} and
     * {@link java.nio.DoubleBuffer} available.
     */
     ...
     * </p>
     * <p>
     * Since JRE 9, the version string has dropped the major release number, see
     * JEP 223: http://openjdk.java.net/jeps/223
     * </p>
     */
    ...
    /**
     * Usually GlueGen and subsequent JogAmp modules are build using dynamic
     * libraries on supported platforms, hence this boolean is expected to be
     * true.
     * <p>
     * However, on certain systems static libraries are being used on which
     * native JNI library loading is disabled.
     * </p>
     */
    ...
    /**
     * Returns the {@link ABIType} of the current platform using given
     * {@link CPUType cpuType} and {@link OSType osType} as a hint.
     * <p>
     ...
     * </p>
     * <p>
     * Elf ARM Tags are read using {@link ElfHeader}, .. and
     * {@link SectionArmAttributes#abiVFPArgsAcceptsVFPVariant(byte)}.
     * </p>
     */
    /*
     ...
     * {@link OSType}, {@link CPUType}, {@link ABIType} and
     * {@code littleEndian}.
     * <p>
     * Consult 'gluegen/make/gluegen-cpptasks-base.xml' to complete/sync
     * mapping!
     * </p>
     *
